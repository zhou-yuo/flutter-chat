...
/// @author https://blog.csdn.net/jdsjlzx/article/details/134298504
...
class WebSocketUtility {
  /// baseUrl
  static String baseUrl = 'wss://echo.websocket.events';
  ...
  final int _reconnectCount = 3; // 重连次数，默认60次
